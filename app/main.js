...
const gotoLoginListener = () => {
	...
	gotoLogin.onclick = (e) => {
		e.preventDefault() //no quiero que siga lo del href, solo el estilo
		loginPage()
	}
}

const registerPage = () => {
	//console.log('pagina de registro si funciona')
...
//antes que cargue la pagina queremos validar que el usuario haya iniciado sesion, eso lo hacemos con un jwt en localstorage
window.onload = () => {
